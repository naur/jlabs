...
public class JvmOpts extends Sub {
    ...
    private void printCurMem() {
        ...
        System.out.println("\ttotal memory: " + bitTomega(Runtime.getRuntime().totalMemory()) + " M");
        ...
        System.out.println("\tuse memory: " + bitTomega(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) + " M");
